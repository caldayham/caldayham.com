...
export const projectPosts: Post[] = [
    {
        path: 'metal-strandbeest',
        title: '8 Legged Rideable Metal Strandbeest',
    ...
    {
        path: 'rabbit-farm',
        title: 'Medium Scale Meat Rabbit Farm',
    ...
    {
        path: 'cockroach-farm',
        title: 'Large Scale Dubia Cockroach Farm',
